...
def save_and_print_results(result, samples, label: str):
    ...
    csv_path = f"./results/ragas_{label}_{timestamp}.csv"
    ...
    json_path = f"./results/ragas_{label}_{timestamp}.json"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--db",   default="./chroma_db/v9", help="Chroma persist_directory")
    ...
    save_and_print_results(result, samples, label)